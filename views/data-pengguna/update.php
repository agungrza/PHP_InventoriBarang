<?php
    ...
    $users = view("SELECT * FROM users WHERE idUser = $id")[0];
...
<head>
    ...
    <title>Inventori Barang | Update Data Pengguna</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark">Ubah Pengguna</h6>
            </div>
            <div class="card-body">
            <form method="POST" action="">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nip" type="text" class="form-control" name="nip" required autofocus value="<?php echo $users["nip"]?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nama" type="text" class="form-control" name="nama" value="<?php echo $users["nama"]?>" required>
                    </div>
                </div>
