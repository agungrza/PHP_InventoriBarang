...
<head>
    ...
    <title>Inventori Barang | Create Data Pengguna</title>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="nip" type="number" class="form-control" name="nip" required autofocus placeholder="Masukkan NIP">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="nama" type="text" class="form-control" name="nama" required placeholder="Masukkan Nama">
                        </div>
                    </div>
