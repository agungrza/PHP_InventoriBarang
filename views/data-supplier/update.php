<?php
    ...
    $supplier = view("SELECT * FROM supplier WHERE idSupplier = $id")[0];
...
<head>
    ...
    <title>Inventori Barang | Update Data Supplier</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark">Ubah Supplier</h6>
            </div>
            <div class="card-body">
            <form method="POST" action="">
                
                <input type="hidden" id="idSupplier" name="idSupplier" value="<?= $supplier["idSupplier"] ?>">
            
                <div class="row mb-3">
                    <label for="kodeSupplier" class="col-md-4 col-form-label text-md-end">Kode Supplier</label>
            
                    <div class="col-md-6">
                        <input id="kodeSupplier" type="hidden" name="kodeSupplier" value="<?= $supplier["kodeSupplier"]?>" required autofocus>
                        <input type="text" class="form-control" value="<?= $supplier["kodeSupplier"]?>" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="namaSupplier" type="text" class="form-control" name="namaSupplier" value="<?= $supplier["namaSupplier"]?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nohp" type="number" class="form-control" name="nohp" value="<?= $supplier["nohp"]?>" required>
                    </div>
                </div>
