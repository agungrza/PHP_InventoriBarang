<?php
    ...
    $countspl=mysqli_query($conn, "SELECT COUNT(idSupplier) AS id from supplier");
    $spl=mysqli_fetch_assoc($countspl);

    $countgdg=mysqli_query($conn, "SELECT COUNT(idBarang) AS id from gudang");
    $gdg=mysqli_fetch_assoc($countgdg);

    $countmsk=mysqli_query($conn, "SELECT COUNT(idBarangMasuk) AS id from barangmasuk");
    $msk=mysqli_fetch_assoc($countmsk);
    
    $countklr=mysqli_query($conn, "SELECT COUNT(idBarangKeluar) AS id from barangkeluar");
    $klr=mysqli_fetch_assoc($countklr);

    $countbds=mysqli_query($conn, "SELECT COUNT(idBarangBadstock) AS id from barangbadstock");
    $bds=mysqli_fetch_assoc($countbds);
...
<head>
    ...
    <title>Inventori Barang | Dashboard</title>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-md font-weight-bold text-primary text-uppercase mb-1">
                                        Data Supplier</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $spl['id'] ?></div>
                                </div>
                                <div class="col-auto">
                                    <img src="../img/supplier.png" width=50>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-md font-weight-bold text-success text-uppercase mb-1">
                                        Data Gudang</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $gdg['id'] ?></div>
                                </div>
                                <div class="col-auto">
                                    <img src="../img/gudang.png" width=50>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-md font-weight-bold text-info text-uppercase mb-1">Barang Masuk
                                    </div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $msk['id'] ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <img src="../img/barangmasuk.png" width=50>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-md font-weight-bold text-danger text-uppercase mb-1">
                                        Barang Keluar</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $klr['id'] ?></div>
                                </div>
                                <div class="col-auto">
                                    <img src="../img/barangmasuk.png" width=50>
                                </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-md font-weight-bold text-secondary text-uppercase mb-1">
                                        Barang Badstock</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $bds['id'] ?></div>
                                </div>
                                <div class="col-auto">
                                    <img src="../img/badstock.png" width=50>
                                </div>
                            </div>
                        </div>
                    </div>
