<?php
    ...
    $gudang = view("SELECT * FROM gudang WHERE idBarang = $id")[0];
    
    if(isset($_POST["submit"])){
            if(updateBarangGudang($_POST) > 0 ){
                echo "
                    <script>
...
<head>
    ...
    <title>Inventori Barang | Update Data Barang Gudang</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-dark">Ubah Barang Gudang</h6>
            </div>
            <div class="card-body">
            <form method="POST" action="">

                <input type="hidden" name="idBarang" id="idBarang" value="<?= $gudang["idBarang"] ?>">
            
                <div class="row mb-3">
                    <label for="kodeBarang" class="col-md-4 col-form-label text-md-end">Kode Barang</label>
            
                    <div class="col-md-6">
                        <input id="kodeBarang" type="hidden" name="kodeBarang" value="<?= $gudang["kodeBarang"]?>" required autofocus>
                        <input type="text" class="form-control" value="<?= $gudang["kodeBarang"]?>" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="namaBarang" type="text" class="form-control" name="namaBarang" value="<?= $gudang["namaBarang"]?>" required>
                    </div>
                </div>
                ...
                <input id="stok" type="hidden" name="stok" value="<?= $gudang["stok"]?>" required>

                <input id="user_id" type="hidden" name="user_id" value="<?= $_SESSION['id'] ?>" required>
